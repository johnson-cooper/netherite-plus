...
public class ItemIronBoatItem extends Item
{
    public ItemIronBoatItem(int par1)
    {
        super(par1);
        this.maxStackSize = 1;
    }
            ...
            else
            {
                if (var24.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    if (!par2World.isRemote)
                    {
                        ...
                        par2World.spawnEntityInWorld(new EntityIronBoat(par2World, (double)((float)var33 + 0.5F), (double)((float)var34 + 1.0F), (double)((float)var35 + 0.5F)));
                    }
